...
Interact with the number guessing bot by choosing a number in your head- beginging the program, and saying lower or higher until the bot guesses your number. A console number game.
